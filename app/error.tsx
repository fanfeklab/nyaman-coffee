...
export default function ErrorPage({
  ...
  return (
    <div className="flex bg-[#FFFDF7] h-screen w-full flex-col items-center justify-center space-y-4 text-center p-6">
      ...
      <Button onClick={() => reset()} className="px-6 py-3 h-auto border-4 border-black bg-black hover:bg-gray-800 text-white font-black uppercase hover:-translate-y-1 hover:shadow-[4px_4px_0_0_rgba(255,255,255,1)] transition-all">
        COBA LAGI
      </Button>
    </div>
  );
